...
{
    public class ImageProcessAsync4 : ImageProcess
    {
        public override string DestinationPath { get { return Path.Combine(Environment.CurrentDirectory, "ASyncOutput4"); } }

        public override string Name { get { return "非同步4(Await Task版本)"; } }
